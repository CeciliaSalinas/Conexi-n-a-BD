...
Module Utiles
    Public libreriaSQL As New ClsLibreriaSql
    Public PId As Long
    ...
    Public Function GeneraCsv(ByVal Grilla As DataGridView) As Boolean
        Dim resultado As Boolean
        Try
    ...
    Public Function GeneraTxt(ByVal Grilla As DataGridView, ByVal titulo As String, ByVal subtitulo As String) As Boolean
        Dim resultado As Boolean
        Try
            Dim strExport As String
            Dim ruta As String
